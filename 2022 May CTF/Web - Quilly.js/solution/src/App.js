...
export default function App() {
  ...
  useEffect(() => {
    ...
    const provider = new WebrtcProvider("flag", ydoc, { password: "lmao", signaling: ["wss://quillyjs-stun.nypinfsecctf.tk"] })
    ...
    */
    ...
    setTimeout(() => {
      setInterval(() => {
        editor.setText("NYP{w3brtc_crdt_madn3ss}", "user");
      }, 1000);
    }, 1000);
